...
AETHON_TEST(handoff_queue_evaluates_thresholds) {
    aethon::pipeline::HandoffQueue component("handoff_queue");
    ...
    AETHON_REQUIRE(!render_handoff_queue_decision(decision).empty());
}
