...
AETHON_TEST(principal_map_evaluates_thresholds) {
    aethon::security::PrincipalMap component("principal_map");
    ...
    AETHON_REQUIRE(!render_principal_map_decision(decision).empty());
}
