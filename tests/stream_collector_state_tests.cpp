...
AETHON_TEST(collector_state_summarizes_weighted_samples) {
    aethon::stream::CollectorState component("collector_state");
...
AETHON_TEST(collector_state_drops_old_samples_1) {
    aethon::stream::CollectorState component("collector_state-window-1");
