...
#include "aethon/telemetry/quality_flag.hpp"

AETHON_TEST(quality_flag_evaluates_thresholds) {
    aethon::telemetry::QualityFlag component("quality_flag");
    ...
    AETHON_REQUIRE(!render_quality_flag_decision(decision).empty());
}
