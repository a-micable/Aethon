...
#include "aethon/integrity/loss_estimator.hpp"

AETHON_TEST(loss_estimator_summarizes_weighted_samples) {
    aethon::integrity::LossEstimator component("loss_estimator");
