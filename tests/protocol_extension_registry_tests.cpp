...
AETHON_TEST(extension_registry_summarizes_weighted_samples) {
    aethon::protocol::ExtensionRegistry component("extension_registry");
...
AETHON_TEST(extension_registry_drops_old_samples_1) {
    aethon::protocol::ExtensionRegistry component("extension_registry-window-1");
