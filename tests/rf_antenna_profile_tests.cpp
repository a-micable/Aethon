...
AETHON_TEST(antenna_profile_evaluates_thresholds) {
    aethon::rf::AntennaProfile component("antenna_profile");
    ...
    AETHON_REQUIRE(!render_antenna_profile_decision(decision).empty());
}
