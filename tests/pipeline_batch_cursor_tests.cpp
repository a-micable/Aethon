...
#include "aethon/pipeline/batch_cursor.hpp"

AETHON_TEST(batch_cursor_evaluates_thresholds) {
    aethon::pipeline::BatchCursor component("batch_cursor");
    ...
    AETHON_REQUIRE(!render_batch_cursor_decision(decision).empty());
}
