...
AETHON_TEST(slo_window_evaluates_thresholds) {
    aethon::observability::SloWindow component("slo_window");
    ...
    AETHON_REQUIRE(!render_slo_window_decision(decision).empty());
}
