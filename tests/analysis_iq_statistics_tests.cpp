...
AETHON_TEST(iq_statistics_summarizes_weighted_samples) {
    aethon::analysis::IqStatistics component("iq_statistics");
...
AETHON_TEST(iq_statistics_drops_old_samples_1) {
    aethon::analysis::IqStatistics component("iq_statistics-window-1");
