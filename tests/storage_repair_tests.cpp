...
AETHON_TEST(repair_summarizes_weighted_samples) {
    aethon::storage::ArchiveRepair component("repair");
...
AETHON_TEST(repair_drops_old_samples_1) {
    aethon::storage::ArchiveRepair component("repair-window-1");
