...
AETHON_TEST(device_note_evaluates_thresholds) {
    aethon::telemetry::DeviceNote component("device_note");
    ...
    AETHON_REQUIRE(!render_device_note_decision(decision).empty());
}
