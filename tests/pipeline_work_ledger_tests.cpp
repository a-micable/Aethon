...
#include "aethon/pipeline/work_ledger.hpp"

AETHON_TEST(work_ledger_evaluates_thresholds) {
    aethon::pipeline::WorkLedger component("work_ledger");
    ...
    AETHON_REQUIRE(!render_work_ledger_decision(decision).empty());
}
