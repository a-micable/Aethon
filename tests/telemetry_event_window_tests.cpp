...
AETHON_TEST(event_window_evaluates_thresholds) {
    aethon::telemetry::EventWindow component("event_window");
    ...
    AETHON_REQUIRE(!render_event_window_decision(decision).empty());
}
