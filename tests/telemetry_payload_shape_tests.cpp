...
AETHON_TEST(payload_shape_evaluates_thresholds) {
    aethon::telemetry::PayloadShape component("payload_shape");
    ...
    AETHON_REQUIRE(!render_payload_shape_decision(decision).empty());
}
