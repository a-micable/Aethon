...
ArchiveIndex build_archive_index(const std::filesystem::path& path) {
    ...
    std::sort(
        index.records.begin(),
        index.records.end(),
        [](const ArchiveIndexEntry& left, const ArchiveIndexEntry& right) {
